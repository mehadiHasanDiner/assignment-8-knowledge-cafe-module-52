      ...
      <div className="px-2 xs:px-32 md:px-32">
        ...
        <div className="border-2 border-purple-400 p-2 m-4 rounded-lg bg-purple-100">
          ...
          <p className="text-justify">
            <span className="font-bold">Ans:</span> Props and State are both
            used to manage data in react but there some differences to them.
            There are as follow: state:
          </p>
        ...
        <div className="border-2 border-purple-400 p-2 m-4 rounded-lg bg-purple-100">
          ...
          <p className="text-justify">
            ...
            is used to store and update any variable value on a component level.
            The reason why we would store the variable value inside the state is
            so that we can access those values without any sort of DOM
        ...
        <div className="border-2 border-purple-400 p-2 m-4 rounded-lg bg-purple-100">
          ...
          <p className="text-justify mb-4">
            ...
            by breaking the UI down into reusable components and updating the
            actual DOM using a virtual DOM and a process called reconciliation.
            React follows a one-way data flow model and provides hooks for
            managing state. Overall, React is a powerful and flexible tool for
